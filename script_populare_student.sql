...
DECLARE
  ...
  lista_materii_an_1 varr := varr('Logic�', 'Matematic�', 'Introducere �n programare', 'Arhitectura calculatoarelor �i sisteme de operare', 'Sisteme de operare', 'Programare orientat�-obiect', 'Fundamente algebrice ale informaticii', 'Probabilit��i �i statistic�');
  lista_materii_an_2 varr := varr('Re�ele de calculatoare', 'Baze de date', 'Limbaje formale, automate �i compilatoare', 'Algoritmica grafurilor', 'Tehnologii WEB', 'Programare avansat�', '	Ingineria Program�rii', 'Practic� SGBD');
  lista_materii_an_3 varr := varr('�nv��are automat�', 'Securitatea informa�iei', 'Inteligen�� artificial�', 'Practic� - Programare �n Python', 'Calcul numeric', 'Grafic� pe calculator', 'Managementul clasei de elevi', 'Re�ele Petri �i aplica�ii');
